...
const Toggle = ({ checked, onChange, label }: { checked: boolean, onChange: (e: React.MouseEvent) => void, label?: string }) => (
  ...
  >
    ...
    />
    {label && (
      <span className={`absolute text-[0.5625rem] font-bold ${checked ? 'left-2 text-white' : 'right-2 text-white/60'}`}>
        {checked ? 'ON' : 'OFF'}
      </span>
    )}
  </button>
          ...
          <div id="section-cisternas" className="bg-white/5 border border-white/10 rounded-3xl p-6 flex flex-col shadow-lg backdrop-blur-md relative">
            ...
            <div className="flex-1 flex items-center justify-center gap-8 relative">
              ...
              <div className="flex flex-col items-center">
                <span className="text-[0.625rem] font-bold text-white/80 uppercase mb-2 text-center w-20 leading-tight">Nível Caixa D'água: 85%</span>
              ...
              <div className="flex flex-col items-center mt-20">
                <span className="text-[0.625rem] font-bold text-white/80 uppercase mb-2 text-center w-20 leading-tight">Nível Cisterna Jardim: 90%</span>
            ...
            <div className="mt-6 flex flex-col xl:flex-row gap-4 items-end">
              <div className="flex-1 w-full">
                ...
                <p className="text-[0.625rem] font-bold text-white/80 uppercase">Capacidade: 72% | 12.000 L</p>
              </div>

              <div className="bg-white/5 border border-white/10 rounded-2xl p-4 flex-1 w-full">
                <h3 className="text-[0.625rem] font-bold text-white uppercase mb-3">Controle de Bombas</h3>
                <div className="space-y-3">
                  ...
                  <div className="pt-2 text-center">
                    <p className="text-[0.625rem] text-white/50 uppercase">Próximo ciclo de reuso</p>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-[0.625rem] text-white/60">{lights.cozinha}%</span>
                    </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-[0.625rem] text-white/60">{lights.sala}%</span>
                    </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-[0.625rem] text-white/60">{lights.jardim}%</span>
                    </div>
