          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-[0.625rem] font-black uppercase tracking-[0.3em] text-emerald-400/60">Home IOT - Automação Residencial</span>
              </div>
            ...
            <nav className="flex items-center gap-4">
              {[
                ...
                >
                  ...
                  <span className="text-[0.5rem] font-bold uppercase tracking-widest">{item.label}</span>
                </button>
              ))}
            </nav>
          </div>
              ...
              <div className="flex flex-col items-center py-4">
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <span className="text-[0.5rem] font-bold text-white/40 uppercase tracking-widest">Processados</span>
                  </div>
                </div>
                ...
                <div className="mt-8 w-full space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[0.625rem] font-bold text-white/60 uppercase">Processados</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[0.625rem] font-bold text-white/60 uppercase">Em Processamento</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[0.625rem] font-bold text-white/60 uppercase">Pendentes</span>
                    </div>
              ...
              <div className="space-y-6 py-2">
                {barData.map((item, idx) => (
                  <div key={idx} className="space-y-2">
                    <div className="flex justify-between text-[0.625rem] font-bold text-white/40 uppercase tracking-widest">
                      <span>{item.name}</span>
                ...
                <div className="flex justify-between text-[0.5rem] font-bold text-white/20 uppercase tracking-[0.3em] pt-2">
                  <span>0</span>
                  <span>40</span>
                  <span>80</span>
                  <span>120</span>
                ...
                <div className="flex flex-col items-center">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      ...
                      <span className="text-[0.5rem] font-bold text-white/40 uppercase tracking-widest text-center max-w-[80px]">Assinaturas Rápidas & Validações</span>
                    </div>
                  </div>
                  <div className="mt-6 flex items-center gap-6">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-emerald-500" />
                      <span className="text-[0.625rem] font-bold text-emerald-400 uppercase">TMD Total: 98%</span>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                      <AlertTriangle className="w-3 h-3 text-amber-500" />
                      <span className="text-[0.5rem] font-bold text-amber-500 uppercase">Alertas Críticos: R$ 4.500 (1 OS em atraso)</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <GlassCard title="PRÓXIMOS CICLOS DE ASSINATURA">
                <div className="flex flex-col items-center justify-center py-4">
                  ...
                  >
                    ...
                    <span className="text-[0.625rem] font-bold uppercase tracking-widest">Automatizado</span>
                  </button>
                </div>
              </GlassCard>
              ...
              <GlassCard title="CONTROLE DE FLUXO">
                <div className="space-y-6 py-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-[0.625rem] font-bold text-white/70 uppercase tracking-widest">Assinatura Sinal</div>
                      <div className="text-[0.5rem] text-white/30 uppercase mt-0.5">Fluxo Principal</div>
                    </div>
                    <button 
                    ...
                    >
                      ...
                      />
                      <span className={`absolute ${isSinalActive ? 'left-2' : 'right-2'} top-1.5 text-[0.375rem] font-black text-white`}>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-[0.625rem] font-bold text-white/70 uppercase tracking-widest">Validação Técnica</div>
                      <div className="text-[0.5rem] text-white/30 uppercase mt-0.5">Fluxo de Engenharia</div>
                    </div>
                    <button 
                    ...
                    >
                      <motion.div 
                        ...
                        className="absolute top-1 w-4 h-4 bg-white rounded-full shadow-lg"
                      />
                      <span className={`absolute ${isValidationActive ? 'left-2' : 'right-2'} top-1.5 text-[0.375rem] font-black text-white`}>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            >
              <div className="space-y-2">
                <div className="grid grid-cols-5 text-[0.5rem] font-black text-white/20 uppercase tracking-widest pb-2">
                ...
                {digitalFolder.length === 0 ? (
                  ...
                  digitalFolder.slice(0, 6).map((item, idx) => (
                    <div key={item.id} className="grid grid-cols-5 items-center p-2 bg-white/5 rounded-xl border border-white/5 hover:bg-white/10 transition-all group">
                      <span className="col-span-1 text-[0.625rem] font-bold text-white/40">{new Date(item.date).toLocaleDateString('pt-BR', { weekday: 'short' })}</span>
                      <span className="col-span-3 text-[0.625rem] font-bold text-white/80 truncate">{item.title}</span>
                      <div className="col-span-1 flex justify-end">
                        <span className={`text-[0.5rem] font-black uppercase px-2 py-1 rounded-md ${item.status === 'VALIDATED' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-amber-500/10 text-amber-400'}`}>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start gap-3 group cursor-pointer">
                    ...
                    <p className="text-[0.625rem] font-bold text-white/60 leading-tight group-hover:text-white transition-colors">
                      {item.title}
                    </p>
                  </div>
                ))}
            ...
            <div className="space-y-4">
              <h3 className="text-[0.625rem] font-black uppercase tracking-[0.2em] text-white/40 px-2">Botoes de Ação</h3>
              ...
              >
                ...
                <span className="text-[0.625rem] font-black uppercase tracking-widest text-white/70 group-hover:text-white">Iniciar Assinatura Principal</span>
              </button>
              ...
              >
                ...
                <span className="text-[0.625rem] font-black uppercase tracking-widest text-white/70 group-hover:text-white">Visualizar Documentos Gerais</span>
              </button>
              ...
              >
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[0.625rem] font-black uppercase tracking-widest text-white/70 group-hover:text-white">Status Assinatura</span>
                  <span className={`text-[0.5rem] font-bold uppercase ${isStatusActive ? 'text-emerald-400' : 'text-rose-400'}`}>
              ...
              >
                ...
                <span className="text-[0.625rem] font-black uppercase tracking-widest text-white/70 group-hover:text-white">Document Factory</span>
              </button>
            </div>
          </div>
