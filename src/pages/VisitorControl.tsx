              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <span className={`text-[0.625rem] font-black uppercase tracking-widest px-2 py-1 rounded-md ${
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <div>
                  <p className="text-[0.625rem] font-black uppercase tracking-widest text-white/40">Visitante</p>
                  <p className="text-xl font-bold text-white">{selectedVisitor.name}</p>
                </div>
                <div className="flex justify-center gap-8">
                  <div>
                    <p className="text-[0.625rem] font-black uppercase tracking-widest text-white/40">Apto</p>
                    <p className="text-lg font-bold text-white">{selectedVisitor.apartment}</p>
                  </div>
                  <div>
                    <p className="text-[0.625rem] font-black uppercase tracking-widest text-white/40">Torre</p>
