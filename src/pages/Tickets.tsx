    ...
    <div className="min-h-screen bg-[#004a7c] text-white -m-8 p-4 sm:p-8 md:p-12 overflow-x-hidden relative flex flex-col">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-[0.625rem] text-white/60 mt-3 font-medium line-clamp-1 flex items-center gap-1.5">
      ...
      >
        <div className="space-y-8 p-2">
          <div className="flex items-center gap-4 text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-400/10 p-4 rounded-2xl border border-amber-200 dark:border-amber-400/20">
            <ShieldAlert className="w-8 h-8 shrink-0" />
            <p className="font-medium leading-relaxed text-zinc-900 dark:text-white">Tem certeza que deseja excluir este atendimento? Esta ação não pode ser desfeita.</p>
          </div>
          
          <div className="flex justify-end gap-4 pt-6 border-t border-zinc-100 dark:border-white/10">
            <button 
              onClick={() => setTicketToDelete(null)}
              className="px-8 py-4 text-zinc-500 dark:text-white/60 hover:text-zinc-900 dark:hover:text-white font-bold transition-colors uppercase tracking-widest text-xs"
            >
              CANCELAR
            </button>
            <button 
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-8 py-4 rounded-2xl font-black tracking-widest shadow-lg shadow-red-500/20 transition-all active:scale-95 text-xs"
            >
              EXCLUIR
            </button>
          </div>
