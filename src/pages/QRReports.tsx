        ...
        <div className="flex items-center gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[0.625rem] font-black uppercase tracking-[0.3em] text-white/40">Reports Center</span>
            </div>
                  ...
                  <div className="w-full lg:w-80 h-64 lg:h-auto bg-white/5 relative overflow-hidden group/img">
                    {report.photoBefore ? (
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center text-white/10">
                        ...
                        <span className="text-[0.625rem] font-black uppercase tracking-[0.2em] opacity-40">Sem Registro Visual</span>
                      </div>
                    )}
                    <div className="absolute top-6 left-6 bg-black/60 backdrop-blur-xl text-white px-4 py-2 rounded-xl text-[0.625rem] font-black uppercase tracking-[0.2em] border border-white/10">
                      Pendente
                    </div>
                  </div>
                  ...
                  <div className="flex-1 p-8 lg:p-12 flex flex-col justify-between">
                    <div>
                      <div className="flex flex-wrap items-center gap-6 mb-8">
                        <div className="flex items-center gap-2 text-[0.625rem] font-black text-white/30 uppercase tracking-widest">
                        ...
                        <div className="flex items-center gap-2 text-[0.625rem] font-black text-amber-400 uppercase tracking-widest">
                      ...
                      <div className="mb-8">
                        <span className="text-[0.625rem] font-black uppercase tracking-[0.2em] text-white/20 block mb-2">Relatado por {report.reportedBy}</span>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-6 pt-8 border-t border-white/5">
                      <div className="flex items-center gap-4">
                        <button
                          ...
                          className="bg-emerald-500 hover:bg-emerald-400 text-black px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-[0.625rem] flex items-center gap-3 transition-all shadow-lg shadow-emerald-500/20 active:scale-95"
                        >
                        ...
                        <button
                          ...
                          className="bg-white/5 hover:bg-red-500 text-white px-8 py-4 rounded-2xl font-black uppercase tracking-widest text-[0.625rem] flex items-center gap-3 transition-all border border-white/10 active:scale-95"
                        >
                      ...
                      <button
                        ...
                        className="text-white/30 hover:text-white transition-all flex items-center gap-2 text-[0.625rem] font-black uppercase tracking-widest"
                      >
                        Detalhes
