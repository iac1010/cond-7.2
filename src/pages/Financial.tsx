  ...
  return (
    ...
    >
        ...
        <header className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8 relative z-10 border-b border-white/10 pb-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <motion.button 
              ...
              className="bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 px-6 py-3 flex items-center gap-2 border border-purple-500/30 transition-all rounded-2xl backdrop-blur-2xl font-black uppercase tracking-widest text-[0.625rem] shadow-[0_0_30px_rgba(168,85,247,0.1)]"
            >
            ...
            <motion.button 
              ...
              className="bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 px-6 py-3 flex items-center gap-2 border border-emerald-500/30 transition-all rounded-2xl backdrop-blur-2xl font-black uppercase tracking-widest text-[0.625rem] shadow-[0_0_30px_rgba(16,185,129,0.1)]"
            >
            ...
            <motion.button 
              ...
              className="bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-400 px-6 py-3 flex items-center gap-2 border border-cyan-500/30 transition-all rounded-2xl backdrop-blur-2xl font-black uppercase tracking-widest text-[0.625rem] shadow-[0_0_30px_rgba(6,182,212,0.1)]"
            >
            ...
            <motion.button 
              ...
              className="bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 px-6 py-3 flex items-center gap-2 border border-rose-500/30 transition-all rounded-2xl backdrop-blur-2xl font-black uppercase tracking-widest text-[0.625rem] shadow-[0_0_30px_rgba(244,63,94,0.1)]"
            >
              <Plus className="w-4 h-4" /> 
              <span>Custo</span>
            </motion.button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16 relative z-10">
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-white/30 font-black uppercase tracking-[0.2em] text-[0.625rem]">Key Performance</h3>
            <div className="px-3 py-1 bg-white/5 rounded-full text-[0.5rem] font-black uppercase tracking-widest text-white/40 border border-white/10">Monitoring</div>
          </div>
          
          <div className="space-y-6">
            <div>
              <div className="flex justify-between items-end mb-2">
                <span className="text-[0.625rem] font-black uppercase tracking-widest text-white/60">Meta de Receita</span>
            ...
            <div>
              <div className="flex justify-between items-end mb-2">
                <span className="text-[0.625rem] font-black uppercase tracking-widest text-white/60">Limite de Despesas</span>
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-white/30 font-black uppercase tracking-[0.2em] text-[0.625rem]">Real Time Activity</h3>
            <div className="px-3 py-1 bg-cyan-500/10 rounded-full text-[0.5rem] font-black uppercase tracking-widest text-cyan-400 border border-cyan-500/20">Tracking</div>
          </div>
          ...
          <div className="flex items-center gap-12">
            <div className="relative w-32 h-32 flex-shrink-0">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="text-[0.5rem] font-black text-white/20 uppercase tracking-widest">Efficiency</span>
              </div>
            </div>
              ...
              {[0, 1, 2, 3, 4, 5, 6, 7].map(i => {
                ...
                return (
                  <div key={i} className="aspect-square bg-white/5 rounded-2xl border border-white/5 flex flex-col items-center justify-center group/item hover:bg-cyan-500/10 hover:border-cyan-500/20 transition-all p-2 text-center overflow-hidden">
                    {receipt ? (
                      <>
                        <span className="text-[0.5rem] font-black text-white/40 truncate w-full mb-1">{receipt.description}</span>
                        <span className="text-[0.625rem] font-black text-cyan-400">R$ {receipt.value.toLocaleString('pt-BR')}</span>
                        <span className="text-[0.375rem] font-medium text-white/20 mt-1">{safeFormatDate(receipt.date)}</span>
                      </>
                    ) : (
                      <span className="text-[0.625rem] font-black text-white/10 group-hover/item:text-cyan-400">0{i + 1}</span>
                    )}
                  </div>
                );
              })}
