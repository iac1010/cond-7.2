            ...
            <div className="bg-white border border-slate-200 rounded-[2rem] p-8 shadow-inner h-[600px] overflow-y-auto font-serif text-black leading-relaxed whitespace-pre-wrap text-sm">
              {isEditingPreview ? (
                ...
                <div ref={printRef} className="bg-white text-zinc-900 min-h-full relative p-16 pdf-content font-sans" style={{ color: '#18181b' }}>
                  ...
                  {/* Info Bar */}
                  <div className="relative z-10 grid grid-cols-3 gap-8 p-6 bg-zinc-50 rounded-3xl border border-zinc-100 mb-16">
                    <div>
                      <p className="text-[0.5625rem] font-black text-zinc-400 uppercase tracking-widest mb-1">Endereço</p>
                      <p className="text-[0.6875rem] text-zinc-600 font-medium leading-relaxed">
                        {companyData?.address || 'Endereço não informado'}
                      </p>
                    </div>
                    <div>
                      <p className="text-[0.5625rem] font-black text-zinc-400 uppercase tracking-widest mb-1">Contato</p>
                      <p className="text-[0.6875rem] text-zinc-600 font-medium">
                    ...
                    <div>
                      <p className="text-[0.5625rem] font-black text-zinc-400 uppercase tracking-widest mb-1">Registro</p>
                      <p className="text-[0.6875rem] text-zinc-600 font-medium">
                  ...
                  <div className="relative z-10 mt-auto pt-12 border-t border-zinc-100 page-break-inside-avoid">
                    <div className="grid grid-cols-2 gap-20 w-full mb-16">
                      <div className="flex flex-col items-start">
                        <div className="w-full h-px bg-zinc-200 mb-4"></div>
                        <p className="text-[0.625rem] font-black text-zinc-400 uppercase tracking-widest mb-1">Responsável / Síndico</p>
                        <p className="text-xs font-bold text-zinc-900">{companyData?.name || 'Assinatura Autorizada'}</p>
                      </div>
                      <div className="flex flex-col items-start">
                        <div className="w-full h-px bg-zinc-200 mb-4"></div>
                        <p className="text-[0.625rem] font-black text-zinc-400 uppercase tracking-widest mb-1">Testemunha / Condômino</p>
