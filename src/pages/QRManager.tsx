        ...
        >
          {/* Header Text */}
              <div className="w-full text-center mb-6 relative z-10">
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <span style={{ color: '#a1a1aa' }} className="text-[0.625rem] font-black uppercase tracking-[0.4em]">
          ...
          <div style={{ backgroundColor: '#f4f4f5', borderColor: '#e4e4e7' }} className="w-full flex-1 rounded-[4rem] border p-6 flex flex-col items-center relative shadow-inner">
            ...
            <div className="flex-1 flex flex-col items-center justify-center w-full">
              ...
              <div className="mt-6 text-center">
                <span style={{ color: '#71717a' }} className="text-[0.625rem] font-black uppercase tracking-[0.4em]">Escaneie o Código</span>
              </div>
            </div>
            ...
            <div style={{ backgroundColor: '#18181b' }} className="w-full h-[65mm] rounded-[3.5rem] p-10 flex flex-col justify-center shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <span style={{ color: 'rgba(255, 255, 255, 0.3)' }} className="text-[0.625rem] font-black uppercase tracking-[0.2em] mb-2 block">Localização</span>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex flex-col">
                    <span style={{ color: 'rgba(255, 255, 255, 0.3)' }} className="text-[0.5625rem] font-black uppercase tracking-[0.2em] mb-1">Condomínio</span>
                    <span style={{ color: 'rgba(255, 255, 255, 0.7)' }} className="text-sm font-bold uppercase tracking-wide">
                      {selectedClient?.name}
                    </span>
                  </div>
                  <div className="flex flex-col items-end">
                    <span style={{ color: 'rgba(255, 255, 255, 0.2)' }} className="text-[0.5rem] font-mono uppercase">ID: {printingLocation?.id.slice(0,8)}</span>
          ...
          <div className="w-full mt-8 flex items-center justify-between px-6 relative z-10">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span style={{ color: '#a1a1aa' }} className="text-[0.6875rem] font-black uppercase tracking-[0.2em]">
                  {companyData?.name || 'FLORES'}
                </span>
                <span style={{ color: '#d4d4d8' }} className="text-[0.5rem] font-bold uppercase tracking-widest">Gestão de Manutenção</span>
              </div>
            </div>
            <div className="flex flex-col items-end">
              {companySignature && (
                <img 
                  ...
                  alt="Assinatura" 
                  className="h-10 object-contain opacity-40 grayscale mb-1" 
                  referrerPolicy="no-referrer" 
                />
              )}
              <span style={{ color: '#d4d4d8' }} className="text-[0.5625rem] font-black uppercase tracking-[0.3em]">Powered by QR Studio</span>
            </div>
          </div>
        </div>
      </div>
              ...
              {selectedClient.locations?.slice(pageIndex * 4, (pageIndex * 4) + 4).map((loc) => (
                <div key={loc.id} style={{ backgroundColor: '#f4f4f5', borderColor: '#e4e4e7' }} className="border rounded-[3.5rem] p-4 flex flex-col items-center relative shadow-inner overflow-hidden">
                  ...
                  <div style={{ backgroundColor: '#18181b' }} className="w-full h-[45mm] rounded-[2.5rem] p-6 flex flex-col justify-center shadow-xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <span style={{ color: 'rgba(255, 255, 255, 0.2)' }} className="text-[0.375rem] font-black uppercase tracking-widest block mb-1">
                      ...
                      <div style={{ borderTopColor: 'rgba(255, 255, 255, 0.05)' }} className="pt-3 border-t flex justify-between items-center">
                        <span style={{ color: 'rgba(255, 255, 255, 0.2)' }} className="text-[0.3125rem] font-mono uppercase">ID: {loc.id.slice(0,8)}</span>
                        <span style={{ color: 'rgba(255, 255, 255, 0.4)' }} className="text-[0.375rem] font-black uppercase tracking-widest">
                          {companyData?.name || 'FLORES'}
                        </span>
                      </div>
                    </div>
