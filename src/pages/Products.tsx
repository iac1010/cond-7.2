    ...
    <div className="min-h-screen bg-[#004a7c] text-white -m-8 p-8 md:p-12 overflow-x-hidden relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Nome do Produto *</label>
              <input 
                type="text" 
                value={formData.name}
            ...
            <div>
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Código / SKU</label>
              <input 
                type="text" 
                value={formData.code}
            ...
            <div>
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Unidade de Medida</label>
              <input 
                type="text" 
                value={formData.unit}
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Preço de Venda (R$) *</label>
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-400 dark:text-white/30 font-bold">R$</span>
                <input 
                  type="number" 
                  value={formData.price || ''}
                  onChange={(e) => setFormData({...formData, price: parseFloat(e.target.value) || 0})}
                  className="w-full bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/10 focus:border-zinc-400 dark:focus:border-white/30 rounded-xl pl-12 pr-4 py-3 outline-none transition-all text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-white/30"
                  min="0"
                  step="0.01"
                  required
                />
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Descrição / Detalhes</label>
              <textarea 
                value={formData.description}
                onChange={(e) => setFormData({...formData, description: e.target.value})}
                className="w-full bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/10 focus:border-zinc-400 dark:focus:border-white/30 rounded-xl px-4 py-3 outline-none min-h-[100px] resize-none transition-all text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-white/30"
          ...
          <div className="pt-6 flex justify-end gap-3">
            <button 
              ...
              className="px-6 py-3 text-zinc-400 dark:text-white/60 hover:text-zinc-900 dark:hover:text-white transition-colors font-medium"
            >
              Cancelar
            </button>
            <button 
      ...
      >
        <div className="space-y-6 p-2">
          <p className="text-xl font-light text-zinc-600 dark:text-white/70">
