                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`px-4 py-1 rounded-full text-[0.625rem] font-black uppercase tracking-widest border ${
                            ...
                            <div key={resp.supplierId} className="bg-white/5 p-4 rounded-2xl border border-white/5 hover:border-white/20 transition-all">
                              ...
                              {resp.status === 'RECEIVED' ? (
                                <div className="flex justify-between items-end">
                                  ...
                                  <button className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 hover:text-white transition-colors">Ver Detalhes</button>
                                </div>
                              ) : (
