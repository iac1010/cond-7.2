        ...
        >
          ...
          <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-8 mb-10 grid grid-cols-2 gap-x-12 gap-y-6">
            ...
            <div>
              ...
              <div className="h-20 flex items-end justify-center border-b border-zinc-300 pb-1 relative">
                {companySignature && (
                  <img 
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-zinc-100 border-y border-zinc-300">
                <th className="py-3 px-2 text-center text-[0.625rem] font-black uppercase tracking-widest text-zinc-600 w-12">OK</th>
                <th className="py-3 px-2 text-center text-[0.625rem] font-black uppercase tracking-widest text-zinc-600 w-12">NOK</th>
                <th className="py-3 px-2 text-center text-[0.625rem] font-black uppercase tracking-widest text-zinc-600 w-12">N/A</th>
                <th className="py-3 px-4 text-left text-[0.625rem] font-black uppercase tracking-widest text-zinc-600">Item / Descrição</th>
                <th className="py-3 px-4 text-left text-[0.625rem] font-black uppercase tracking-widest text-zinc-600 w-48">Observações</th>
              </tr>
            </thead>
            <tbody>
