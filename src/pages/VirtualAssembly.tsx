            ...
            assemblies.map((assembly) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div className={`text-[0.625rem] font-black uppercase tracking-wider px-2 py-1 rounded-md border ${
                        ...
                        <div className="space-y-3">
                          {selectedAssembly.votes.slice(0, 3).map((vote) => (
                            <div key={vote.id} className="flex items-center justify-between p-3 bg-white/5 rounded-xl border border-white/10">
                              ...
                              <code className="text-[0.625rem] text-blue-400 font-mono">{vote.signature}</code>
                            </div>
                          ))}
