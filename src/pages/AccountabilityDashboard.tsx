        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[0.625rem] font-black text-emerald-400 bg-emerald-500/10 px-3 py-1 rounded-full">Mensal</span>
            </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[0.625rem] font-black text-blue-400 bg-blue-500/10 px-3 py-1 rounded-full">{operationalCosts.staff.length} Colaboradores</span>
            </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[0.625rem] font-black text-indigo-400 bg-indigo-500/10 px-3 py-1 rounded-full">Síndico</span>
            </div>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[0.625rem] font-black text-amber-400 bg-amber-500/10 px-3 py-1 rounded-full">+2.5% vs Mês Ant.</span>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-white/40 text-[0.625rem] font-black uppercase tracking-widest">Total Economizado</p>
                <p className="text-2xl font-black text-emerald-400">R$ {totalSaved.toLocaleString('pt-BR')}</p>
              </div>
              <div className="h-12 w-px bg-white/10 mx-2" />
              <div className="text-right">
                <p className="text-white/40 text-[0.625rem] font-black uppercase tracking-widest">Progresso Geral</p>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[0.625rem] text-white/40 uppercase font-black tracking-widest">{goal.category}</p>
                    </div>
                  </div>
                ...
                <tbody className="divide-y divide-white/5">
                  {operationalCosts.staff.map(member => (
                    <tr key={member.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="px-8 py-6">
                        <span className="px-3 py-1 rounded-full text-[0.625rem] font-black uppercase tracking-widest bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
                          Ativo
                        </span>
                      </td>
                    </tr>
                            ...
                            <div className="flex items-center gap-2">
                              <div className="flex -space-x-2">
                                {item.signatures.map((s, idx) => (
                                  <div key={idx} className="w-8 h-8 rounded-full bg-indigo-600 border-2 border-[#004a7c] flex items-center justify-center text-[0.625rem] text-white font-black" title={`${s.userName} (${s.role})`}>
                                    {s.userName.charAt(0)}
                                  </div>
                                ))}
                                {[...Array(Math.max(0, 3 - item.signatures.length))].map((_, idx) => (
                                  <div key={idx} className="w-8 h-8 rounded-full bg-white/5 border-2 border-[#004a7c] flex items-center justify-center text-[0.625rem] text-white/20 font-black">
                                    ?
                                  </div>
                                ))}
                              </div>
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-b border-white/10">
                        <th className="pb-4 text-[0.625rem] font-black uppercase tracking-widest text-white/40">Descrição</th>
                        <th className="pb-4 text-[0.625rem] font-black uppercase tracking-widest text-white/40">Categoria</th>
                        <th className="pb-4 text-[0.625rem] font-black uppercase tracking-widest text-white/40">Data</th>
                        <th className="pb-4 text-right text-[0.625rem] font-black uppercase tracking-widest text-white/40">Valor</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-white/5">
                      {costs.map((cost) => (
                        <tr key={cost.id} className="group hover:bg-white/5 transition-all">
                          ...
                          <td className="py-4">
                            <span className="px-3 py-1 bg-white/10 rounded-full text-[0.625rem] font-black uppercase tracking-widest">
                              {cost.category}
                            </span>
                          </td>
            ...
            <div className="bg-white/5 p-8 rounded-[40px] border border-white/10 backdrop-blur-md">
              ...
              <div className="bg-white/10 p-8 rounded-[40px] border border-white/10 backdrop-blur-md">
                ...
                <div className="p-4 bg-black/20 rounded-2xl border border-white/10 mb-6">
                  <p className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2">Hash de Segurança</p>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="text-right">
                      <span className={`text-[0.625rem] font-black uppercase tracking-widest px-3 py-1 rounded-full ${isCompleted ? 'bg-emerald-500/20 text-emerald-400' : 'bg-white/10 text-white/60'}`}>
                        {goal.category}
                      </span>
                  ...
                  <div className="mt-8 space-y-4">
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="flex-1 bg-white/5 hover:bg-white/10 py-2.5 rounded-xl text-[0.625rem] font-black transition-all"
                      >
                        +100
                      </button>
                      <button 
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              <div>
                <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Descrição</label>
                <input 
                  type="text" 
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Valor (R$)</label>
                  <input 
                    type="number" 
                    value={newCost.value}
                ...
                <div>
                  <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Data</label>
                  <input 
                    type="date" 
                    value={newCost.date}
              ...
              <div>
                <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Categoria</label>
                <select 
      ...
      {isAddGoalModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              <div>
                <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Título do Projeto</label>
                <input 
                  type="text" 
                  value={newGoal.title}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Meta (R$)</label>
                  <input 
                    type="number" 
                ...
                <div>
                  <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Valor Inicial (R$)</label>
                  <input 
                    type="number" 
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Data Alvo</label>
                  <input 
                    type="date" 
              ...
              <div>
                <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Ícone</label>
                <select 
                  value={newGoal.icon}
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <div className="space-y-4 relative z-10">
              ...
              <div>
                <label className="text-[0.625rem] font-black uppercase tracking-widest text-white/40 mb-2 block">Valor Atual (R$)</label>
                <input 
                  type="number" 
