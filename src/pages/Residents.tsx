            ...
            >
              ...
              <div className="mt-4 relative z-10">
                ...
                {client.contactPerson && (
                  <p className="text-[0.625rem] md:text-sm opacity-80 flex items-center gap-1 drop-shadow-md">
              ...
              <div className="mt-auto pt-4 space-y-2 border-t border-white/10 relative z-10">
                <div className="flex items-center text-[0.6875rem] md:text-sm gap-2 drop-shadow-md">
                  <Phone className="w-3.5 md:w-4 h-3.5 md:h-4 opacity-70" />
                  <span className="font-medium">{client.phone}</span>
                </div>
                {client.email && (
                  <div className="flex items-center text-[0.6875rem] md:text-sm gap-2 truncate drop-shadow-md">
                    <Mail className="w-3.5 md:w-4 h-3.5 md:h-4 opacity-70" />
                    <span className="truncate">{client.email}</span>
                  </div>
                )}
                <div className="flex items-start text-[0.6875rem] md:text-sm gap-2 mt-2 drop-shadow-md">
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6 p-2">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Veículos</label>
              <input 
                type="text" 
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Pets</label>
              <input 
                type="text" 
                value={formData.pets}
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Endereço *</label>
              <textarea 
                required
                value={formData.address}
                onChange={e => setFormData({...formData, address: e.target.value})}
                className="w-full bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/10 focus:border-zinc-400 dark:focus:border-white/30 rounded-xl px-4 py-3 outline-none min-h-[80px] resize-none transition-all text-zinc-900 dark:text-white placeholder:text-zinc-400 dark:placeholder:text-white/30"
                placeholder="Rua, Número, Bairro, Cidade"
              />
            </div>

            <div className="md:col-span-2">
              <label className="block text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-white/50 mb-2">Observações</label>
              <textarea 
