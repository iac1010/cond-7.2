              ...
              >
                <div className="flex items-center justify-between gap-2 mb-3">
                  <div className="flex flex-col gap-0.5 min-w-0">
                    <span className="text-[0.4375rem] font-black uppercase tracking-[0.2em] text-white/20 truncate">{goal.category || 'Objetivo'}</span>
                    <span className="text-[0.6875rem] font-black text-white group-hover:text-amber-400 transition-colors truncate">{goal.title}</span>
                  </div>
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center text-[0.5rem] font-black uppercase tracking-wider">
                ...
                <div className="grid grid-cols-2 gap-2 mt-2 pt-2 border-t border-white/5">
                  <div className="flex flex-col">
                    <span className="text-[0.4375rem] font-black text-white/20 uppercase tracking-widest">Atual</span>
                    <span className="text-[0.5625rem] font-bold text-white truncate">R$ {goal.currentAmount.toLocaleString()}</span>
                  </div>
                  <div className="flex flex-col items-end">
                    <span className="text-[0.4375rem] font-black text-white/20 uppercase tracking-widest">Meta</span>
                    <span className="text-[0.5625rem] font-bold text-white/40 truncate">R$ {goal.targetAmount.toLocaleString()}</span>
                  </div>
                </div>
              </motion.div>
            );
      ...
      {!hideFooter && displayGoals.length > 0 && (
        <div className="mt-8 flex items-center justify-between px-2 relative z-10 border-t border-white/5 pt-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[0.625rem] font-black uppercase tracking-[0.4em] text-white/40">Objetivos em Tempo Real</span>
          </div>
          <div className="text-[0.625rem] font-black uppercase tracking-widest text-white/20">
