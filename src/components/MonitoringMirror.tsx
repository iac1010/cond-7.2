    ...
    <div className={`relative bg-slate-900/40 backdrop-blur-2xl border border-white/20 p-4 rounded-[2.2rem] shadow-2xl overflow-hidden ${className}`}>
      ...
      <div className="flex gap-3 h-24 relative z-10">
        ...
        >
          ...
          <span className={`text-[0.5625rem] font-black uppercase tracking-wider ${isPumpOn ? 'text-white' : 'text-white/40'}`}>
            Bomba d'Água
          </span>
          {isPumpOn && (
        ...
        >
          ...
          <span className={`text-[0.5625rem] font-black uppercase tracking-wider ${isGateOpen ? 'text-white' : 'text-white/40'}`}>
            Portão Garagem
          </span>
          {isGateOpen && (
      ...
      {showLabel && (
        <div className="mt-4 flex justify-between items-center px-1 relative z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[0.5625rem] font-black uppercase tracking-[0.2em] text-white/50">Acionamento Rápido</span>
          </div>
