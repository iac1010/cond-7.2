      ...
      {showLabel && (
        <div className="mt-3 md:mt-5 flex justify-between items-center px-1 relative z-10 gap-2">
          <div className="flex items-center gap-1.5 md:gap-2.5 min-w-0">
            ...
            <span className="text-[0.5rem] md:text-[0.625rem] font-black uppercase tracking-[0.1em] md:tracking-[0.3em] text-white/50 truncate">Board Mirror</span>
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <span className="text-[0.5rem] md:text-[0.625rem] font-black text-white/80 bg-white/10 px-1.5 md:px-2.5 py-0.5 md:py-1 rounded-lg border border-white/10 backdrop-blur-md">
              {tickets.length}
            </span>
          </div>
        </div>
