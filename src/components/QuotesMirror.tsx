        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-2">
            <div className="flex items-center gap-1">
              ...
              <span className="text-[0.5rem] font-bold text-white/50">{pendingQuotes.length}</span>
            </div>
            <div className="flex items-center gap-1">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-400" />
              <span className="text-[0.5rem] font-bold text-white/50">{approvedQuotes.length}</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="flex-1 space-y-2 overflow-hidden">
        ...
        {quotes.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full py-4 opacity-20">
            ...
            <p className="text-[0.625rem] font-bold uppercase tracking-widest">Nenhum orçamento</p>
          </div>
        )}
      </div>
    </div>
