      ...
      <div className="flex-1 flex flex-col relative z-10 overflow-hidden">
        ...
        >
          <div className="flex flex-col items-center justify-center text-center">
            <p className="text-[0.625rem] font-black uppercase text-white/40 mb-2 tracking-[0.3em]">Saldo Atual</p>
      ...
      <div className="flex justify-between items-end relative z-10 mt-2 gap-2">
        <div className="flex items-center gap-2 md:gap-3 min-w-0">
          ...
          <div className="flex flex-col min-w-0">
            <span className="text-[0.5rem] md:text-[0.625rem] font-black uppercase tracking-[0.2em] drop-shadow-md truncate">Gestão Financeira</span>
