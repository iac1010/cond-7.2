    ...
    >
      ...
      <div className="flex items-start gap-2 md:gap-4 h-full relative z-10">
        ...
        <div className="overflow-hidden flex-1">
          <p className="text-[0.5rem] md:text-[0.625rem] font-black uppercase text-white/70 mb-0.5 md:mb-1 tracking-[0.2em] truncate">Insumos</p>
          <div className="space-y-0.5 md:space-y-1">
            ...
            <div className="flex items-center gap-1.5 md:gap-2 text-white/80">
              ...
              <p className="text-[0.625rem] md:text-sm font-bold truncate">
      ...
      <span className="hidden md:block text-[0.6875rem] font-black uppercase tracking-[0.2em] relative z-10 text-white/70">Materiais</span>
    </Link>
  );
};
