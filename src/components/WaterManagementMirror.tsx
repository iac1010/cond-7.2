    ...
    <div className={`relative bg-slate-900/40 backdrop-blur-2xl border border-white/20 p-5 rounded-[2.2rem] shadow-2xl overflow-hidden ${className}`}>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-end mb-1">
              <span className="text-[0.625rem] font-black uppercase tracking-[0.2em] text-white/50">Nível Reservatório</span>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white/5 rounded-2xl p-3 border border-white/5 flex flex-col gap-1">
            <div className="flex items-center gap-2 text-white/40">
              ...
              <span className="text-[0.5rem] font-black uppercase tracking-wider">Consumo Hoje</span>
            </div>
            <span className="text-sm font-black text-white">{todayWater.toLocaleString('pt-BR')} <span className="text-[0.625rem] font-normal opacity-50">m³</span></span>
          </div>
          
          <div className="bg-white/5 rounded-2xl p-3 border border-white/5 flex flex-col gap-1">
            <div className="flex items-center gap-2 text-white/40">
              <Zap className="w-3 h-3" />
              <span className="text-[0.5rem] font-black uppercase tracking-wider">Status Bombas</span>
            </div>
            <div className="flex items-center gap-1.5">
              ...
              <span className={`text-[0.625rem] font-bold uppercase ${hasCriticalPump ? 'text-red-400' : allPumpsNormal ? 'text-emerald-400' : 'text-amber-400'}`}>
      ...
      {!hideFooter && (
        <div className="mt-4 flex items-center gap-2.5 px-1 relative z-10">
          ...
          <span className="text-[0.625rem] font-black uppercase tracking-[0.3em] text-white/50">Gestão Hídrica Smart</span>
        </div>
      )}
    </div>
  );
